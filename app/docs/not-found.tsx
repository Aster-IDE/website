...
import { FaExternalLinkAlt, FaHome, FaBook } from "react-icons/fa";
        ...
        <div className="space-y-8 max-w-2xl">
          <div>
            <div className="flex items-center justify-center gap-3 mb-4">
              <FaBook className="text-4xl text-[#FF82B4]" />
              <h1
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            The AsterIDE documentation is hosted on its own dedicated subdomain for better organization and navigation.
            <br />
            You can find all our documentation at <strong>docs.asteride.dev</strong>
          </p>
          ...
          <div className="mt-8 p-6 bg-accent/30 rounded-lg border border-border">
            <div className="text-sm text-muted-foreground space-y-2">
              ...
              <p>Better organization for technical documentation</p>
              <p>Dedicated space for guides and API references</p>
              <p>Improved searchability for technical content</p>
